...
const typeNum = (arr) => {
  // Solution code here...
  let newArray = arr.filter(num => typeof num === 'number');
...
const containsAnd = (arr) => {
  ...
  newArray = arr.filter(str => typeof str === 'string' && str.includes('and'));
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let newArray = arr.filter(num => !forbiddenValues.includes(num));
